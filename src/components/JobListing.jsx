...
const JobListing = () => {
  ...
  return (
    <section className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      {/* ----- Sidebar ----- */}
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        {/* ----- Category Filter ----- */}
        <div className={showfilter ? " pb-10" : "max-lg:hidden"}>
